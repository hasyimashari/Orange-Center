        ...
        <div className='relative w-full h-screen max-h-screen bg-[url("src/assets/bg_db.png")] bg-center bg-cover flex flex-row'>
            ...
            <div className="relative h-screen flex flex-col gap-6 w-[5%] sm:w-[8%] min-w-[5%] pt-36">
                ...
                <div onClick={setAdministrationPage} className="w-full hover:bg-white rounded-lg hover:bg-opacity-25 cursor-pointer">
                    <img src={Administrasi} className='h-[2rem] w-[2rem] sm:h-[1.7rem] sm:w-[1.7rem] mx-auto m-2' alt="" />
                </div>
                ...
                <div onClick={setPermintaanPage} className="w-full hover:bg-white rounded-lg hover:bg-opacity-25 cursor-pointer">
                    <img src={Permintaan} className='h-[2rem] w-[2rem] sm:h-[1.7rem] sm:w-[1.7rem] mx-auto m-2' alt="" />
                </div>
            </div>

            <div className="relative w-[95%] sm:w-[92%]">
                {/* header */}
                <div onClick={setDashboadPage} className="w-full h-[8rem] sm:h-[7rem] flex items-center cursor-pointer">
