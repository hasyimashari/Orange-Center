...
return (
    <>
        <div className="max-w-sm flex item-center justify-center mx-auto mt-8">
            <form onSubmit={onSubmit}>
                <h1 className="font-bold text-4xl pb-4">Daftar</h1>
                ...
                <div className="flex justify-between text-sm my-6">
                    ...
                    <button type="submit" className="text-sm w-4/12 p-5 text-center bg-gradient-to-tr from-[#4E944F] from-4%  to-[#B4E197] to-90% hover:brightness-90 py-2 rounded-3xl shadow-xl flex justify-between text-white cursor-pointer">Daftar <img src={Arrow_right}/></button>
                </div>
            </form>
        </div>
    </>
